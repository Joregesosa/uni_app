...
?>
        ...
        <ul class="py-8 gap-8 flex flex-col">
            ...
            <li class="flex gap-6 text-lg">
                ...
                <a href="index.php?controller=AdminController&action=list_roles">Permisos</a>
    ...
    case 2:
    ?>
        <h2 class="uppercase w-full text-center text-xl">Menu Maestro</h2>
        <ul class="py-8 gap-8 flex flex-col">
            ...
            <li class="flex gap-6 text-lg">
                ...
                <a href="?controller=TeacherController&action=list_students">Alumnos</a>
    ...
    case 3:
    ?>
        <h2 class="uppercase w-full text-center text-xl">Menu Estudiante</h2>
        <ul class="py-8 gap-8 flex flex-col">
            ...
            <li class="flex gap-6 text-lg">
                ...
                <a href="?controller=StudentController&action=list_record">Ver Calificaciones</a>
            ...
            <li class="flex gap-6 text-lg">
                ...
                <a href="?controller=AdminController&action=list_students">Administrar Clases</a>
