 ...
 <div class=" w-[90%] mx-auto border-1 border-cyan-300 bg-slate-100 rounded-lg">
     ...
     <div class="flex w-full border-b border-cyan-300 px-4 items-center justify-between">
         ...
         <a href="?controller=AdminController&action=list_teachers&modal=admin_create_teacher&modal_act=without_teacher" class=":hoverbg-blue-400 bg-blue-500 text-cyan-100 flex font-medium px-3 py-2 rounded-lg hover:text-cyan-800">
             Agregar Maestro
         </a>
             ...
             <tbody>
                 ...
                 <?php foreach ($data as $key => $row) : ?>
                     <tr>
                         ...
                         <td>
                             <a href="?controller=AdminController&action=list_teachers&modal=admin_edit_teacher&modal_act=without_teacher&row=<?= $key ?> ">
