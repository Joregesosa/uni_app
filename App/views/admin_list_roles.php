             ...
             <tbody>
                 ...
                 <?php foreach ($data as $key => $row) : ?>
                     <tr>
                         ...
                         <td>
                             <a href="?controller=AdminController&action=list_roles&modal=edit_user_role&user=<?= $key ?>">
 ...
 <?php
    ...
    function role($role)
    {
        switch ($role) {
            ...
            default:
                return '<span class="flex bg-gray-700 px-2 py-[2px] text-gray-50 text-sm  w-fit rounded-md font-medium">Alumno</span>';
                break;
        }
    }
